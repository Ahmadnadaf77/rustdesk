...
- **Windows builds** require:
  - Additional DLLs (`flutter_windows.dll`, etc.)
  - Virtual display drivers
  - Complete Release folder (not just .exe) for distribution
  - Visual Studio 2022 with C++ build tools
  - vcpkg for C++ dependencies
  - **Important:** Single .exe file won't work - needs all Flutter dependencies!
